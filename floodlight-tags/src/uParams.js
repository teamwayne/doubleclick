...
var UPARAMS = {
  ...
  */
  getUParams: function(brand, pageId) {
    var customVars = {};
    customVars.siteBrand = brand;
    customVars.pagePath = pageId;
    if (Array.isArray(b.adobe_products)) {
      var products = b.adobe_products[0];
    ...
    if (typeof b !== 'undefined') {
      customVars.crodsId = b.adobe_primary_customer_id;
      customVars.policyNumber = b.data_policyNumber;
      customVars.sessionId = b.tealium_session_id;
      customVars.transactionId = b.data_receiptNumber;
      customVars.paymentMethod = this.cleanStr(b.data_paymentMethod, ['visa','mastercard','creditcard','directdebit','paypal']);
      customVars.paymentFrequency = this.cleanStr(b.data_paymentFrequency, ['annual','monthly','halfyear']);
      customVars.remarketingSlice = b.remarketing_slice; // PER-3529
    ...
    // PER-6551 Search utag_data if not found in the b object.  
      ...
      customVars.paymentMethod = this.cleanStr(w.utag_data.data_paymentMethod, ['visa','mastercard','creditcard','directdebit','paypal']);
      customVars.paymentFrequency = this.cleanStr(w.utag_data.data_paymentFrequency, ['annual','monthly','halfyear']);
